        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full h-full">
          <div className="flex flex-col justify-center items-center h-full max-w-md mx-auto">
            ...
            <div className="text-center mb-12">
              <h1 className="text-5xl md:text-6xl lg:text-6xl font-heading font-normal text-foreground mb-4" style={{ lineHeight: 1.2 }}>
                One login.<br />
                One AI.<br />
            ...
            <div className="w-full space-y-4">
              ...
              <Button 
                onClick={() => navigate('/auth')}
                variant="outline"
                className="w-full flex items-center justify-center gap-3 py-3 h-auto text-base bg-background hover:bg-muted"
              >
              ...
              <Button 
                onClick={() => navigate('/auth')}
                className="w-full bg-foreground hover:bg-foreground/90 text-background text-base py-3 h-auto"
              >
                Continue with email
              </Button>
