        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full pt-10">
          <div className="flex flex-col lg:flex-row lg:items-center lg:gap-16 h-full">
            ...
            <div className="text-center lg:text-left lg:flex-1 mb-8 lg:mb-0">
              ...
              <div className="mt-4 inline-block px-4 py-2 border border-orange-500 bg-orange-500 rounded-full">
                <p className="text-sm md:text-base text-white font-body font-medium">
