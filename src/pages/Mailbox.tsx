        ...
        <div className={`grid gap-6 ${isDrawerView ? 'grid-cols-1' : 'lg:grid-cols-3'}`}>
          ...
          <Card className="lg:col-span-1 min-w-0">
            <CardContent className="p-0 overflow-hidden rounded-lg">
              <ScrollArea className="h-[calc(100vh-12rem)] md:h-[calc(100vh-8rem)] lg:h-[calc(100vh-18rem)] w-full rounded-lg overflow-hidden">
                ...
                <CardContent className="p-0">
                  {selectedConversation ? (
                    <div className="h-[calc(100vh-4rem)]">
                      ...
                      <ScrollArea className="h-[calc(100vh-12rem)] md:h-[calc(100vh-8rem)] lg:h-[calc(100vh-18rem)]">
